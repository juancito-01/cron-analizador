// Generated from c:/Users/Juan/OneDrive/Escritorio/cron.g4/analizador-cron/cron.g4 by ANTLR 4.13.1
...
public class cronParser extends Parser {
	...
	public static final int
		...
		STAR=10, NUMBER=11, WS=12;
	public static final int
		RULE_schedule = 0, RULE_time_field = 1, RULE_value = 2, RULE_range = 3, 
		RULE_step = 4, RULE_wildcard = 5, RULE_list = 6, RULE_item = 7, RULE_predefined = 8;
	private static String[] makeRuleNames() {
		return new String[] {
			"schedule", "time_field", "value", "range", "step", "wildcard", "list", 
			"item", "predefined"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'-'", "'/'", "','", "'@yearly'", "'@monthly'", "'@weekly'", "'@daily'", 
			"'@hourly'", "'@reboot'", "'*'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, null, null, "STAR", "NUMBER", 
			"WS"
		};
	}
	...
	public static class ScheduleContext extends ParserRuleContext {
		public List<Time_fieldContext> time_field() {
			return getRuleContexts(Time_fieldContext.class);
		}
		public Time_fieldContext time_field(int i) {
			return getRuleContext(Time_fieldContext.class,i);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Time_fieldContext extends ParserRuleContext {
		...
		public Time_fieldContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_time_field; }
	}

	public final Time_fieldContext time_field() throws RecognitionException {
		Time_fieldContext _localctx = new Time_fieldContext(_ctx, getState());
		enterRule(_localctx, 2, RULE_time_field);
		try {
			setState(33);
			_errHandler.sync(this);
	...
	public static class ValueContext extends ParserRuleContext {
		public TerminalNode NUMBER() { return getToken(cronParser.NUMBER, 0); }
	...
	public static class RangeContext extends ParserRuleContext {
		public List<TerminalNode> NUMBER() { return getTokens(cronParser.NUMBER); }
		public TerminalNode NUMBER(int i) {
			return getToken(cronParser.NUMBER, i);
		}
